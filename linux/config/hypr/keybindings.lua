...
hl.bind(SUPER .. " + d", hl.dsp.exec_cmd("u_fuzzel"))
hl.bind("SUPER + CTRL + d", hl.dsp.exec_cmd("u_fuzzel --theme"))
...
hl.bind("SUPER + CTRL + c", hl.dsp.exec_cmd('cliphist list | u_fuzzel --dmenu --prompt="clip: " --placeholder="Search clipboard…" | cliphist decode | wl-copy'))
