...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      XXXXXXX,              KC_LALT, KC_LGUI, KC_SPC,   MO(1),   KC_ENTER, KC_RGUI, KC_RALT, XXXXXXX, XXXXXXX,    XXXXXXX),
  ...
  [1] = LAYOUT(
      ...
      XXXXXXX,              KC_LALT, KC_LGUI, KC_SPC,   XXXXXXX, KC_ENTER, KC_RALT, KC_LEFT, KC_DOWN, KC_UP,    KC_RIGHT),
