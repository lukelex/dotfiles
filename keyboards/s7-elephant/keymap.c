...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
      ...
      KC_F1,   KC_TAB,         KC_Q,       KC_W,    KC_E,          KC_R,    KC_T,    KC_Y,       KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,    KC_RBRC, KC_BSPC,          KC_PGUP,
      KC_F2,   LCTL_T(KC_ESC), KC_A,       KC_S,    KC_D,          KC_F,    KC_G,    KC_H,       KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,             KC_ENT,           KC_PGDN,
      KC_F3,   KC_LSFT,        KC_Z,       KC_X,    KC_C,          KC_V,    KC_B,    KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH,             KC_RSFT,          KC_UP,   KC_END,
      KC_F4,   KC_LALT,        KC_LALT,    KC_LGUI,                                  LT(2, KC_SPC),                XXXXXXX, MO(3),   MO(4),               KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [3] = LAYOUT_all(
      _______, _______,        RALT(KC_N), _______, _______,       _______, _______, RALT(KC_I), _______, _______, _______, _______, _______,    _______, _______, _______, _______,
  ...
  [4] = LAYOUT_all(
      ...
      RGB_MOD, RGB_HUD,        RGB_SAD,    RGB_VAD, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RALT(KC_E),          XXXXXXX,          XXXXXXX,
