...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_all(
    RESET,    RALT(KC_N),     _______,    _______, _______,       _______, _______, RALT(KC_I), _______, _______, _______, _______, LGUI(KC_MINS), _______,    _______, _______, TG(1),
    RGB_TOG,  _______,        _______,    _______, RALT(KC_QUOT), _______, _______,             _______, _______, _______, _______, _______,       _______,    _______, _______,
    RGB_MOD,  _______,        RALT(KC_A), _______, _______,       _______, _______,             _______, _______, _______, _______, _______,       RALT(KC_E), _______,
