...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      XXXXXXX,              KC_LALT, KC_LGUI, XXXXXXX,    LT(2, KC_SPC), XXXXXXX,  XXXXXXX,    MO(3),   XXXXXXX, MO(4),    XXXXXXX),
  ...
  [1] = LAYOUT(
      ...
      KC_LSFT,XXXXXXX,      KC_Z,    KC_X,    KC_C,       KC_V,          KC_B,     KC_N,       KC_M,    KC_COMM, KC_DOT,   KC_SLSH,   KC_RSFT,    MO(4),
      XXXXXXX,              KC_LALT, KC_LGUI, XXXXXXX,    KC_SPC,        XXXXXXX,  XXXXXXX,    MO(3),   XXXXXXX, MO(4),    XXXXXXX),
  ...
  [2] = LAYOUT(
      ...
      KC_LSFT,XXXXXXX,      XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,       XXXXXXX,  XXXXXXX,    XXXXXXX, KC_MPRV, KC_MNXT,  KC_MPLY,   XXXXXXX,    MO(4),
      XXXXXXX,              KC_LALT, KC_LGUI, XXXXXXX,    _______,       XXXXXXX,  XXXXXXX,    MO(3),   XXXXXXX, MO(4),    XXXXXXX),

  [3] = LAYOUT(
      RALT(KC_N),           XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,       XXXXXXX,  XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,   LGUI(KC_MINS),    XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX,              XXXXXXX, KC_UP,   XXXXXXX,    XXXXXXX,       XXXXXXX,  RALT(KC_I), XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX, XXXXXXX,
      ...
      XXXXXXX,              XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,       XXXXXXX,  XXXXXXX,    _______, XXXXXXX, MO(4),    XXXXXXX),
  ...
  [4] = LAYOUT(
      ...
      XXXXXXX,              XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,       XXXXXXX,  XXXXXXX,    _______, XXXXXXX, _______,  XXXXXXX),
};
