...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      XXXXXXX,              KC_LALT, KC_LGUI, XXXXXXX,  LT(1, KC_SPC), XXXXXXX,  XXXXXXX, KC_RGUI, XXXXXXX, MO(3),    XXXXXXX),
  ...
  [1] = LAYOUT(
      ...
      KC_LSFT,XXXXXXX,      XXXXXXX, XXXXXXX, BL_DEC,   BL_TOGG,       BL_INC,   BL_STEP, XXXXXXX, KC_MPRV, KC_MNXT,  KC_MPLY,   XXXXXXX,  XXXXXXX,
      XXXXXXX,              KC_LALT, KC_LGUI, XXXXXXX,  KC_SPC,        XXXXXXX,  XXXXXXX, KC_RGUI, XXXXXXX, MO(3),    XXXXXXX),
  ...
  [2] = LAYOUT(
      ...
      KC_LSFT,XXXXXXX,      KC_Z,    KC_X,    KC_C,     KC_V,          KC_B,     KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,   KC_RSFT,  MO(3),
      XXXXXXX,              KC_LALT, KC_LGUI, XXXXXXX,  KC_SPC,        XXXXXXX,  XXXXXXX, KC_RGUI, KC_RALT, MO(3),    XXXXXXX),
