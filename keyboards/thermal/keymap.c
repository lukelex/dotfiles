...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
      ...
      KC_LALT,        KC_LALT,    KC_LGUI,                         LT(2, KC_SPC),                                  MO(3),   MO(4),         MO(5)),
  ...
  [5] = LAYOUT_all(
      ...
      EF_INC,         _______,    _______, _______,       _______, _______, _______,    _______, _______, _______, _______, _______,       _______,  _______,
      EF_DEC,         _______,    _______, _______,       _______, _______, _______,    _______, _______, _______, _______, _______,       _______,
      _______,        _______,    _______, _______,       _______, _______, _______,    _______, _______, _______, _______, _______,       _______,
      _______,        _______,    _______,                                  _______,                               _______, _______,       _______),
