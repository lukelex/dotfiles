...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_all(
    ...
    XXXXXXX,              KC_LALT, KC_LGUI, KC_SPC,     MO(2),   LT(2, KC_ENT), MO(3),      KC_RALT, MO(4),   XXXXXXX),
  ...
  LAYOUT_all(
    ...
    KC_LSFT,              XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX,       XXXXXXX,    KC_VOLD, KC_VOLU, KC_MPRV,  KC_MNXT, KC_MPLY,       XXXXXXX, XXXXXXX,
  ...
  LAYOUT_all(
    ...
    XXXXXXX,              XXXXXXX, XXXXXXX, RALT(KC_C), XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX,
