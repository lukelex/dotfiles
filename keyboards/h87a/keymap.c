...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all(
    ...
    KC_LSFT, XXXXXXX,     KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT,          XXXXXXX,                          KC_UP,
    KC_LALT,              XXXXXXX, KC_LGUI,                    KC_SPC,                                       XXXXXXX, KC_RALT, XXXXXXX, MO(3),                   KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  [3] = LAYOUT_all(
    ...
    XXXXXXX,              XXXXXXX, XXXXXXX,                    XXXXXXX,                                      XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS,                 XXXXXXX, XXXXXXX, XXXXXXX),
};
