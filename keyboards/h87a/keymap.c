...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_all(
    ...
    KC_LCTL,              KC_LGUI, KC_LALT,                   LT(2, KC_SPC),                               KC_RALT, KC_RGUI, KC_RCTL, MO(2),                   KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  [1] = LAYOUT_all(
    ...
    KC_LSFT,              KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, XXXXXXX,                          KC_UP,
    KC_LCTL,              KC_LGUI, KC_LALT,                   KC_SPC,                                      KC_RALT, KC_RGUI, KC_RCTL, MO(2),                   KC_LEFT, KC_DOWN, KC_RGHT),
