...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
      ...
      KC_LSFT, KC_NUBS, KC_Z,       KC_X,          KC_C,    KC_V,    KC_B,       KC_N,          KC_M,    KC_COMM,    KC_DOT,  KC_SLSH,        KC_RSFT, MO(_FIRMWARE),
      KC_LALT,          KC_LALT,    KC_LGUI,                         KC_SPC,              LT(2, KC_SPC),                      KC_RALT, MO(_SHORTCUTS), XXXXXXX, MO(_FIRMWARE)),
  ...
  [_GAMING] = LAYOUT(
      ...
      KC_LSFT, KC_NUBS, KC_Z,       KC_X,          KC_C,    KC_V,    KC_B,       KC_N,          KC_M,    KC_COMM,    KC_DOT,  KC_SLSH,        KC_RSFT, MO(_FIRMWARE),
      KC_LALT,          KC_LALT,    KC_LGUI,                         KC_SPC,              KC_SPC,                             KC_RALT, MO(_SHORTCUTS), KC_APP,  MO(_FIRMWARE)),
  ...
  [_FUNCTION] = LAYOUT(
      ...
      KC_LALT,          KC_LALT,    KC_LGUI,                         KC_SPC,              _______,                            XXXXXXX, XXXXXXX,        XXXXXXX, XXXXXXX),

  [_SHORTCUTS] = LAYOUT(
      RALT(KC_N),       XXXXXXX,    XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, RALT(KC_I), XXXXXXX,       XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX,        XXXXXXX, XXXXXXX,       TG(1),
