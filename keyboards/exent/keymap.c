...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        LCTL_T(KC_ESC),   KC_A,     KC_S,     KC_D,       KC_F,    KC_G,          KC_H,       KC_J,    KC_K,    KC_L,     KC_SCLN, KC_QUOT,       XXXXXXX, KC_ENT,           KC_PGDN,
        KC_LSFT, XXXXXXX, KC_Z,     KC_X,     KC_C,       KC_V,    KC_B,          KC_N,       KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT,                KC_UP,            KC_END,
        KC_LALT,          KC_LALT,  KC_LGUI,              XXXXXXX, LT(2, KC_SPC), XXXXXXX,                      MO(3),    KC_RGUI, MO(4),         KC_LEFT, KC_DOWN,          KC_RGHT),
    ...
    [1] = LAYOUT_all(
        ...
        KC_LSFT, XXXXXXX, KC_Z,     KC_X,     KC_C,       KC_V,    KC_B,          KC_N,       KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT,                KC_UP,            KC_END,
        KC_LALT,          KC_LALT,  KC_LGUI,              XXXXXXX, KC_SPC,        XXXXXXX,                      MO(3),    KC_RGUI, MO(4),         KC_LEFT, KC_DOWN,          KC_RGHT),

    [2] = LAYOUT_all(
        KC_GRV,           KC_F1,    KC_F2,    KC_F3,      KC_F4,   KC_F5,         KC_F6,      KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,        KC_F12,  KC_DEL,   KC_ESC, KC_HOME,
        KC_TAB,           XXXXXXX,  KC_UP,    XXXXXXX,    XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  KC_PSCR, XXXXXXX,       XXXXXXX, XXXXXXX,          KC_PGUP,
        ...
        KC_LCTL,          KC_LALT,  KC_LGUI,              XXXXXXX, KC_SPC,        XXXXXXX,                      MO(3),    KC_RGUI, MO(4),         KC_LEFT, KC_DOWN,          KC_RGHT),

    [3] = LAYOUT_all(
        RALT(KC_N),       XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX, XXXXXXX,       RALT(KC_I), XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, LGUI(KC_MINS), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        KC_TAB,           XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX,          XXXXXXX,
        KC_LCTL,          XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, RALT(KC_E),    XXXXXXX, XXXXXXX,          XXXXXXX,
        KC_LSFT, XXXXXXX, XXXXXXX,  XXXXXXX,  RALT(KC_C), XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,                XXXXXXX,          XXXXXXX,
        KC_LALT,          XXXXXXX,  KC_LGUI,              XXXXXXX, XXXXXXX,       XXXXXXX,                      _______,  XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX,          XXXXXXX),
    ...
    [4] = LAYOUT_all(
        ...
        BL_TOGG,          BL_STEP,  BL_INC,   BL_DEC,     XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX,          XXXXXXX,
