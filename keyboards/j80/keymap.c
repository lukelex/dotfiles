...
[0] = LAYOUT_tkl_ansi(
  ...
  KC_LALT,          XXXXXXX,    KC_LGUI,                                  LT(2, KC_SPC),                          MO(3),      XXXXXXX, XXXXXXX, MO(4),   KC_LEFT, KC_DOWN, KC_RGHT),
...
[1] = LAYOUT_tkl_ansi(
  ...
  _______,          _______,    _______,                                  KC_SPC,                                 _______,    XXXXXXX, XXXXXXX, MO(4),   _______, _______, _______),
...
[3] = LAYOUT_tkl_ansi(
  _______,          _______,    _______, _______,       _______, _______, _______,    _______, _______, _______,  _______,    _______, _______,          _______, _______, _______,
  RALT(KC_N),       _______,    _______, _______,       _______, _______, RALT(KC_I), _______, _______, _______,  _______,    _______, _______, _______, _______, _______, _______,
  _______,          _______,    _______, RALT(KC_QUOT), _______, _______, _______,    _______, _______, _______,  _______,    _______, _______, _______, _______, _______, _______,
  _______,          RALT(KC_A), _______, _______,       _______, _______, _______,    _______, _______, _______,  RALT(KC_E), _______,          _______,
