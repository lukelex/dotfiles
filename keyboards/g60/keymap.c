...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
      ...
      KC_LSFT, XXXXXXX, KC_Z,       KC_X,    KC_C,          KC_V,    KC_B,    KC_N,          KC_M,    KC_COMM, KC_DOT,         KC_SLSH,                       KC_RSFT,       KC_RSFT,        MO(_FIRMWARE),
      KC_LALT,          KC_LALT, KC_LGUI,                            LT(2, KC_SPC),                   KC_RALT, MO(_SHORTCUTS), KC_APP,         MO(_FIRMWARE),                MO(_FIRMWARE)),
  ...
  [_GAMING] = LAYOUT_all(
      ...
      KC_LSFT, XXXXXXX, KC_Z,       KC_X,    KC_C,          KC_V,    KC_B,    KC_N,          KC_M,    KC_COMM, KC_DOT,         KC_SLSH,                       KC_RSFT,       KC_RSFT,        MO(_FIRMWARE),
      KC_LALT,          KC_LALT,    KC_LGUI,                         KC_SPC,                          KC_RALT, MO(_SHORTCUTS), KC_APP,         MO(_FIRMWARE),                XXXXXXX),
  ...
  [_FUNCTION] = LAYOUT_all(
      ...
      KC_LSFT, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, KC_MPRV, KC_MNXT,        KC_MPLY,                       KC_RSFT,       KC_RSFT,        XXXXXXX,
      KC_LALT,          KC_LALT,    KC_LGUI,                         _______,                         XXXXXXX, XXXXXXX,        XXXXXXX,        XXXXXXX,                      XXXXXXX),
  ...
  [_SHORTCUTS] = LAYOUT_all(
      ...
      XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, RALT(KC_C),    XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,        XXXXXXX,                       XXXXXXX,       XXXXXXX,        XXXXXXX,
  ...
  [_FIRMWARE] = LAYOUT_all(
      ...
      XXXXXXX,          XXXXXXX,    XXXXXXX,                         XXXXXXX,                         XXXXXXX, XXXXXXX,        _______,        XXXXXXX,                      _______),
};
